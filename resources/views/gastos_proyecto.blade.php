            ...
            @foreach($gastos as $index => $gasto)
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Aquí podrías agregar botones de editar/eliminar -->
                        <a href="{{ route('gastos.edit', $gasto->id) }}" class="btn btn-warning btn-sm">
                            <i class="fas fa-edit"></i> Editar
                        </a>
                        <form action="{{ route('gastos_proyecto.destroy', $gasto->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar este gasto?');">
                            @csrf
                            @method('DELETE')
