...
<div class="container mt-5">
    <h1 class="text-center mb-4">Reporte Financiero</h1>
    ...
    <!-- Reporte de Ventas -->
    <div class="filter-section mb-4">
        <h2 class="filter-header">Reporte de Ventas ARCES</h2>
        <div class="form-row">
            <div class="col">
    ...
    <!-- Reporte por Cliente -->
    <div class="filter-section mb-4">
        <h2 class="filter-header">Reporte de Ventas por Cliente ARCES</h2>
        <div class="form-row">
            <div class="col">
    ...
    <!-- Reporte de Vouchers -->
    <div class="filter-section mb-4">
        <h2 class="filter-header">Reporte de Vouchers / Carta Cobranza ARCES</h2>
        <div class="form-row">
            <div class="col">
