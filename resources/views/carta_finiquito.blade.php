...
<body>
    ...
    <div class="section">
        <div class="logo-container">
            ...
            <h2>CALLEJÓN DE QUIJANO N° 236, COLONIA CENTRO, ZACATECAS, ZACATECAS TEL: 492 161 6835</h2>
        </div>
        <h3 class="uppercase">CARTA FINIQUITO DE COMPRAVENTA</h3>
        <p class="p2">Zacatecas, Zacatecas, a 24 de Enero de 2025</p>
