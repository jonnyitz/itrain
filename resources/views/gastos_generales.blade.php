...
<div class="container mt-4">
    ...
    <!-- Barra de búsqueda -->
    <form method="GET" action="{{ route('gastos_generales.index') }}" class="mb-4">
...
<div class="modal fade" id="nuevoGastoModal" tabindex="-1" aria-labelledby="nuevoGastoModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="{{ route('gastos_generales.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select id="concepto" name="concepto" class="form-select" required>
                            ...
                            <option value="Egreso de Enganche Diferido">Egreso de Enganche Diferido</option>
